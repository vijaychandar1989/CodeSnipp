...
--exec SearchAllTables1 'AAA'


    CREATE TABLE #Resultsxx (ColumnName nvarchar(370), ColumnValue nvarchar(3630))
...
@SearchStr2
    ...
    SELECT ColumnName, ColumnValue FROM #Resultsxx
END
